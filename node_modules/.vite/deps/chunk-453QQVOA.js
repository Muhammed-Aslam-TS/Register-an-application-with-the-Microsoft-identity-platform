import {
  ...
  version
} from "./chunk-N4T7727N.js";
import {
  BridgeStatusCode
} from "./chunk-I247LP6U.js";
import {
...
async function createV3Controller(config) {
  ...
  const controller = await import("./StandardController-MK5KW6S4.js");
...
async function createController(config) {
  ...
  if (teamsApp.isAvailable() && teamsApp.getConfig().auth.supportsNestedAppAuth) {
    const controller = await import("./NestedAppAuthController-ZOZSYQNA.js");
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-JRFJ7KAN.js");
    }
  } catch (e) {
  }
  return void 0;
...
@azure/msal-browser/dist/index.mjs:
  (*! @azure/msal-browser v3.10.0 2024-02-17 *)
*/
//# sourceMappingURL=chunk-453QQVOA.js.map
